 ...
 * from C:/DATEN/projects/mondrian/mondrian/src/main/java/mondrian/resource/MondrianResource.xml
 * on Thu Jun 18 15:09:07 CEST 2020.
 * It contains a list of messages, and methods to
 * retrieve and format those messages.
 *
 * Sie ist aus der Generierung entstanden, beinhaltet aber noch zusätzlich Ex-Methoden.
 */
public class MondrianResource extends org.eigenbase.resgen.ShadowResourceBundle {
    public MondrianResource() throws java.io.IOException {
    }
    ...
    public static synchronized MondrianResource instance() {
        return (MondrianResource) instance(baseName,
            ...
            java.util.ResourceBundle.getBundle(baseName, getThreadOrDefaultLocale()));
    }
    /**
     * Retrieves the instance of {@link MondrianResource} for the given locale.
     */
    public static synchronized MondrianResource instance(java.util.Locale locale) {
        return (MondrianResource) instance(baseName, locale, java.util.ResourceBundle.getBundle(baseName, locale));
    }
     ...
     */
    public final _Def2 HighCardinalityInDimension = new _Def2("HighCardinalityInDimension",
        "The highCardinality attribute specified on dimension ''{0}'' is deprecated and will be removed in future versions of Mondrian.The feature will produce wrong results in some scenarios and should be used with caution.",
        null);
     ...
     */
    public final _Def4 MdxCubeSlicerMemberError = new _Def4("MdxCubeSlicerMemberError",
        "Failed to add Cube Slicer with member ''{0}'' for hierarchy ''{1}'' on cube ''{2}''", null);

    /**
     * <code>MdxCubeSlicerHierarchyError</code> is '<code>Failed to add Cube Slicer for hierarchy &#39;&#39;{0}&#39;&#39; on cube &#39;&#39;{1}&#39;&#39;</code>'
     */
    public final _Def1 MdxCubeSlicerHierarchyError = new _Def1("MdxCubeSlicerHierarchyError",
     ...
     */
    public final _Def0 MdxCalculatedHierarchyError = new _Def0("MdxCalculatedHierarchyError",
     ...
     */
    public final _Def6 MdxFuncNotHier = new _Def6("MdxFuncNotHier", "Argument ''{0,number}'' of function ''{1}'' must be a hierarchy",
        null);
     ...
     */
    public final _Def4 MdxFormulaNotFound = new _Def4("MdxFormulaNotFound", "Calculated {0} ''{1}'' has not been found in query ''{2}''",
        null);
     ...
     */
    public final _Def0 MdxCantFindMember = new _Def0("MdxCantFindMember",
        "Cannot find MDX member ''{0}''. Make sure it is indeed a member and not a level or a hierarchy.", null);
     ...
     */
    public final _Def4 MdxCalculatedFormulaUsedOnAxis = new _Def4("MdxCalculatedFormulaUsedOnAxis",
     ...
     */
    public final _Def1 MdxCalculatedFormulaUsedOnSlicer = new _Def1("MdxCalculatedFormulaUsedOnSlicer",
     ...
     */
    public final _Def7 MdxCalculatedFormulaUsedInFormula = new _Def7("MdxCalculatedFormulaUsedInFormula",
     ...
     */
    public final _Def4 MdxCalculatedFormulaUsedInQuery = new _Def4("MdxCalculatedFormulaUsedInQuery",
     ...
     */
    public final _Def8 MdxAxisShowSubtotalsNotSupported = new _Def8("MdxAxisShowSubtotalsNotSupported",
     ...
     */
    public final _Def1 MoreThanOneFunctionMatchesSignature = new _Def1("MoreThanOneFunctionMatchesSignature",
     ...
     */
    public final _Def1 MemberNotInLevelHierarchy = new _Def1("MemberNotInLevelHierarchy",
     ...
     */
    public final _Def3 ToggleDrillStateRecursiveNotSupported = new _Def3("ToggleDrillStateRecursiveNotSupported",
     ...
     */
    public final _Def3 CompoundSlicer = new _Def3("CompoundSlicer", "WHERE clause expression returned set with more than one element.",
        null);
     ...
     */
    public final _Def4 FunctionMbrAndLevelHierarchyMismatch = new _Def4("FunctionMbrAndLevelHierarchyMismatch",
     ...
     */
    public final _Def1 CousinHierarchyMismatch = new _Def1("CousinHierarchyMismatch",
        "The member arguments to the Cousin function must be from the same hierarchy. The members are ''{0}'' and ''{1}''.", null);

    /**
     * <code>HierarchyInIndependentAxes</code> is '<code>Hierarchy &#39;&#39;{0}&#39;&#39; appears in more than one independent axis.</code>'
     */
    public final _Def0 HierarchyInIndependentAxes = new _Def0("HierarchyInIndependentAxes",
     ...
     */
    public final _Def0 ArgsMustHaveSameHierarchy = new _Def0("ArgsMustHaveSameHierarchy",
     ...
     */
    public final _Def8 InvalidAxis = new _Def8("InvalidAxis",
        "Invalid axis specification. The axis number must be a non-negative integer, but it was {0,number}.", null);
     ...
     */
    public final _Def6 NonContiguousAxis = new _Def6("NonContiguousAxis",
     ...
     */
    public final _Def3 VisualTotalsAppliedToTuples = new _Def3("VisualTotalsAppliedToTuples",
        "Argument to ''VisualTotals'' function must be a set of members; got set of tuples.", null);

    /**
     * <code>ParameterIsNotModifiable</code> is '<code>Parameter &#39;&#39;{0}&#39;&#39; (defined at &#39;&#39;{1}&#39;&#39; scope) is not modifiable</code>'
     */
    public final _Def1 ParameterIsNotModifiable = new _Def1("ParameterIsNotModifiable",
     ...
     */
    public final _Def0 ParameterDefinedMoreThanOnce = new _Def0("ParameterDefinedMoreThanOnce",
     ...
     */
    public final _Def0 CycleDuringParameterEvaluation = new _Def0("CycleDuringParameterEvaluation",
     ...
     */
    public final _Def3 TwoNullsNotSupported = new _Def3("TwoNullsNotSupported", "Function does not support two NULL member parameters",
        null);

    /**
     * <code>NoTimeDimensionInCube</code> is '<code>Cannot use the function &#39;&#39;{0}&#39;&#39;, no time dimension is available for this cube.</code>'
     */
    public final _Def0 NoTimeDimensionInCube = new _Def0("NoTimeDimensionInCube",
        "Cannot use the function ''{0}'', no time dimension is available for this cube.", null);
     ...
     */
    public final _Def0 CannotImplicitlyConvertDimensionToHierarchy = new _Def0("CannotImplicitlyConvertDimensionToHierarchy",
        "The ''{0}'' dimension contains more than one hierarchy, therefore the hierarchy must be explicitly specified.", null);

    /**
     * <code>HierarchyHasNoAccessibleMembers</code> is '<code>Hierarchy &#39;&#39;{0}&#39;&#39; has no accessible members.</code>'
     */
    public final _Def0 HierarchyHasNoAccessibleMembers = new _Def0("HierarchyHasNoAccessibleMembers",
     ...
     */
    public final _Def3 AvgRollupFailed = new _Def3("AvgRollupFailed",
     ...
     */
    public final _Def0 DrillthroughDisabled = new _Def0("DrillthroughDisabled",
        "Can''t perform drillthrough operations because ''{0}'' is set to false.", null);
     ...
     */
    public final _Def0 DrillthroughCalculatedMember = new _Def0("DrillthroughCalculatedMember",
        "Can''t perform drillthrough operations because ''{0}'' is a calculated member.", null);
     ...
     */
    public final _Def0 ValidMeasureUsingCalculatedMember = new _Def0("ValidMeasureUsingCalculatedMember",
     ...
     */
    public final _Def0 UnsupportedCalculatedMember = new _Def0("UnsupportedCalculatedMember",
        "Calculated member ''{0}'' is not supported within a compound predicate", null);

    /**
     * <code>ConnectStringMandatoryProperties</code> is '<code>Connect string must contain property &#39;&#39;{0}&#39;&#39; or property &#39;&#39;{1}&#39;&#39;</code>'
     */
    public final _Def1 ConnectStringMandatoryProperties = new _Def1("ConnectStringMandatoryProperties",
     ...
     */
    public final _Def0 NonTimeLevelInTimeHierarchy = new _Def0("NonTimeLevelInTimeHierarchy",
     ...
     */
    public final _Def0 TimeLevelInNonTimeHierarchy = new _Def0("TimeLevelInNonTimeHierarchy",
        "Level ''{0}'' does not belong to a time hierarchy, so its level-type must be ''Standard''.", null);
     ...
     */
    public final _Def1 MustSpecifyPrimaryKeyForHierarchy = new _Def1("MustSpecifyPrimaryKeyForHierarchy",
        "In usage of hierarchy ''{0}'' in cube ''{1}'', you must specify a primary key.", null);
     ...
     */
    public final _Def0 MustSpecifyPrimaryKeyTableForHierarchy = new _Def0("MustSpecifyPrimaryKeyTableForHierarchy",
        "Must specify a primary key table for hierarchy ''{0}'', because it has more than one table.", null);
     ...
     */
    public final _Def1 MustSpecifyForeignKeyForHierarchy = new _Def1("MustSpecifyForeignKeyForHierarchy",
     ...
     */
    public final _Def0 LevelMustHaveNameExpression = new _Def0("LevelMustHaveNameExpression",
        "Level ''{0}'' must have a name expression (a ''column'' attribute or an <Expression> child", null);
     ...
     */
    public final _Def0 PublicDimensionMustNotHaveForeignKey = new _Def0("PublicDimensionMustNotHaveForeignKey",
        "Dimension ''{0}'' has a foreign key. This attribute is only valid in private dimensions and dimension usages.", null);
     ...
     */
    public final _Def0 HierarchyMustNotHaveMoreThanOneSource = new _Def0("HierarchyMustNotHaveMoreThanOneSource",
        "Hierarchy ''{0}'' has more than one source (memberReaderClass, <Table>, <Join> or <View>)", null);

    /**
     * <code>DimensionUsageHasUnknownLevel</code> is '<code>In usage of dimension &#39;&#39;{0}&#39;&#39; in cube &#39;&#39;{1}&#39;&#39;, the level &#39;&#39;{2}&#39;&#39; is unknown</code>'
     */
    public final _Def4 DimensionUsageHasUnknownLevel = new _Def4("DimensionUsageHasUnknownLevel",
        "In usage of dimension ''{0}'' in cube ''{1}'', the level ''{2}'' is unknown", null);

    /**
     * <code>CalcMemberHasBadDimension</code> is '<code>Unknown dimension &#39;&#39;{0}&#39;&#39; for calculated member &#39;&#39;{1}&#39;&#39; in cube &#39;&#39;{2}&#39;&#39;</code>'
     */
    public final _Def4 CalcMemberHasBadDimension = new _Def4("CalcMemberHasBadDimension",
     ...
     */
    public final _Def1 CalcMemberHasBothDimensionAndHierarchy = new _Def1("CalcMemberHasBothDimensionAndHierarchy",
        "Cannot specify both a dimension and hierarchy for calculated member ''{0}'' in cube ''{1}''", null);

    /**
     * <code>CalcMemberHasUnknownParent</code> is '<code>Cannot find a parent with name &#39;&#39;{0}&#39;&#39; for calculated member &#39;&#39;{1}&#39;&#39; in cube &#39;&#39;{2}&#39;&#39;</code>'
     */
    public final _Def4 CalcMemberHasUnknownParent = new _Def4("CalcMemberHasUnknownParent",
        "Cannot find a parent with name ''{0}'' for calculated member ''{1}'' in cube ''{2}''", null);
     ...
     */
    public final _Def4 CalcMemberHasDifferentParentAndHierarchy = new _Def4("CalcMemberHasDifferentParentAndHierarchy",
     ...
     */
    public final _Def1 CalcMemberNotUnique = new _Def1("CalcMemberNotUnique", "Calculated member ''{0}'' already exists in cube ''{1}''",
        null);
     ...
     */
    public final _Def4 NeitherExprNorValueForCalcMemberProperty = new _Def4("NeitherExprNorValueForCalcMemberProperty",
        "Member property must have a value or an expression. (Property ''{0}'' of member ''{1}'' of cube ''{2}''.)", null);
     ...
     */
    public final _Def4 ExprAndValueForMemberProperty = new _Def4("ExprAndValueForMemberProperty",
        "Member property must not have both a value and an expression. (Property ''{0}'' of member ''{1}'' of cube ''{2}''.)", null);

    /**
     * <code>MemberFormatterLoadFailed</code> is '<code>Failed to load formatter class &#39;&#39;{0}&#39;&#39; for level &#39;&#39;{1}&#39;&#39;.</code>'
     */
    public final _Def1 MemberFormatterLoadFailed = new _Def1("MemberFormatterLoadFailed",
     ...
     */
    public final _Def1 PropertyFormatterLoadFailed = new _Def1("PropertyFormatterLoadFailed",
     ...
     */
    public final _Def1 HierarchyMustHaveForeignKey = new _Def1("HierarchyMustHaveForeignKey",
        "Hierarchy ''{0}'' in cube ''{1}'' must have a foreign key, since it is not based on the cube''s fact table.", null);
     ...
     */
    public final _Def4 HierarchyInvalidForeignKey = new _Def4("HierarchyInvalidForeignKey",
        "Foreign key ''{0}'' of hierarchy ''{1}'' in cube ''{2}'' is not a column in the fact table.", null);
     ...
     */
    public final _Def1 UdfClassMustBePublicAndStatic = new _Def1("UdfClassMustBePublicAndStatic",
        "Failed to load user-defined function ''{0}'': class ''{1}'' must be public and static", null);
     ...
     */
    public final _Def4 UdfClassWrongIface = new _Def4("UdfClassWrongIface",
        "Failed to load user-defined function ''{0}'': class ''{1}'' does not implement the required interface ''{2}''", null);
     ...
     */
    public final _Def0 UnknownNamedSetHasBadFormula = new _Def0("UnknownNamedSetHasBadFormula", "Named set in cube ''{0}'' has bad formula",
        null);
     ...
     */
    public final _Def7 MeasureOrdinalsNotUnique = new _Def7("MeasureOrdinalsNotUnique",
     ...
     */
    public final _Def1 BadMeasureSource = new _Def1("BadMeasureSource",
        "Cube ''{0}'': Measure ''{1}'' must contain either a source column or a source expression, but not both", null);
     ...
     */
    public final _Def3 DescendantsAppliedToSetOfTuples = new _Def3("DescendantsAppliedToSetOfTuples",
        "Argument to Descendants function must be a member or set of members, not a set of tuples", null);
     ...
     */
    public final _Def1 HierarchyLevelNamesNotUnique = new _Def1("HierarchyLevelNamesNotUnique",
        "Level names within hierarchy ''{0}'' are not unique; there is more than one level with name ''{1}''.", null);

    /**
     * <code>IllegalLeftDeepJoin</code> is '<code>Left side of join must not be a join; mondrian only supports right-deep joins.</code>'
     */
    public final _Def3 IllegalLeftDeepJoin = new _Def3("IllegalLeftDeepJoin",
        "Left side of join must not be a join; mondrian only supports right-deep joins.", null);
     ...
     */
    public final _Def9 LevelTableParentNotFound = new _Def9("LevelTableParentNotFound",
     ...
     */
    public final _Def10 LimitExceededDuringCrossjoin = new _Def10("LimitExceededDuringCrossjoin",
     ...
     */
    public final _Def10 TotalMembersLimitExceeded = new _Def10("TotalMembersLimitExceeded",
        "Total number of Members in result ({0,number}) exceeded limit ({1,number})", null);

    /**
     * <code>MemberFetchLimitExceeded</code> is '<code>Number of members to be read exceeded limit ({0,number})</code>'
     */
    public final _Def11 MemberFetchLimitExceeded = new _Def11("MemberFetchLimitExceeded",
     ...
     */
    public final _Def11 SegmentFetchLimitExceeded = new _Def11("SegmentFetchLimitExceeded",
        "Number of cell results to be read exceeded limit of ({0,number})", null);
     ...
     */
    public final _Def11 IterationLimitExceeded = new _Def11("IterationLimitExceeded", "Number of iterations exceeded limit of {0,number}",
        null);

    /**
     * <code>InvalidHierarchyCondition</code> is '<code>Hierarchy &#39;&#39;{0}&#39;&#39; is invalid (has no members)</code>'
     */
    public final _Def14 InvalidHierarchyCondition = new _Def14("InvalidHierarchyCondition", "Hierarchy ''{0}'' is invalid (has no members)",
        null);

    /**
     * <code>TooManyMessageRecorderErrors</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Exceeded number of allowed errors &#39;&#39;{1,number}&#39;&#39;</code>'
     */
    public final _Def15 TooManyMessageRecorderErrors = new _Def15("TooManyMessageRecorderErrors",
     ...
     */
    public final _Def15 ForceMessageRecorderError = new _Def15("ForceMessageRecorderError",
     ...
     */
    public final _Def16 UnknownLevelName = new _Def16("UnknownLevelName",
        "Context ''{0}'': The Hierarchy Level ''{1}'' does not have a Level named ''{2}''", null);

    /**
     * <code>DuplicateLevelNames</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Two levels share the same name &#39;&#39;{1}&#39;&#39;</code>'
     */
    public final _Def9 DuplicateLevelNames = new _Def9("DuplicateLevelNames", "Context ''{0}'': Two levels share the same name ''{1}''",
        null);

    /**
     * <code>DuplicateLevelColumnNames</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Two levels, &#39;&#39;{1}&#39;&#39; and &#39;&#39;{2}&#39;&#39;,  share the same foreign column name &#39;&#39;{3}&#39;&#39;</code>'
     */
    public final _Def17 DuplicateLevelColumnNames = new _Def17("DuplicateLevelColumnNames",
        "Context ''{0}'': Two levels, ''{1}'' and ''{2}'',  share the same foreign column name ''{3}''", null);

    /**
     * <code>DuplicateMeasureColumnNames</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Two measures, &#39;&#39;{1}&#39;&#39; and &#39;&#39;{2}&#39;&#39;,  share the same column name &#39;&#39;{3}&#39;&#39;</code>'
     */
    public final _Def17 DuplicateMeasureColumnNames = new _Def17("DuplicateMeasureColumnNames",
        "Context ''{0}'': Two measures, ''{1}'' and ''{2}'',  share the same column name ''{3}''", null);
     ...
     */
    public final _Def17 DuplicateLevelMeasureColumnNames = new _Def17("DuplicateLevelMeasureColumnNames",
        "Context ''{0}'': The level ''{1}'' and the measuer ''{2}'',  share the same column name ''{3}''", null);
     ...
     */
    public final _Def16 DuplicateFactForeignKey = new _Def16("DuplicateFactForeignKey",
     ...
     */
    public final _Def16 UnknownLeftJoinCondition = new _Def16("UnknownLeftJoinCondition",
        "Context ''{0}'': Failed to find left join condition in fact table ''{1}'' for foreign key ''{2}''.", null);

    /**
     * <code>UnknownHierarchyName</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Hierarchy &#39;&#39;{1}&#39;&#39; does not exist&quot;</code>'
     */
    public final _Def9 UnknownHierarchyName = new _Def9("UnknownHierarchyName", "Context ''{0}'': The Hierarchy ''{1}'' does not exist\"",
        null);

    /**
     * <code>BadLevelNameFormat</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Level name &#39;&#39;{1}&#39;&#39; should be [usage hierarchy name].[level name].</code>'
     */
    public final _Def9 BadLevelNameFormat = new _Def9("BadLevelNameFormat",
        "Context ''{0}'': The Level name ''{1}'' should be [usage hierarchy name].[level name].", null);

    /**
     * <code>BadMeasureNameFormat</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Measures name &#39;&#39;{1}&#39;&#39; should be [Measures].[measure name].</code>'
     */
    public final _Def9 BadMeasureNameFormat = new _Def9("BadMeasureNameFormat",
        "Context ''{0}'': The Measures name ''{1}'' should be [Measures].[measure name].", null);
     ...
     */
    public final _Def9 EmptyAttributeString = new _Def9("EmptyAttributeString",
        "Context ''{0}'': The value for the attribute ''{1}'' is empty (length is zero).", null);
     ...
     */
    public final _Def16 BadRolapStarLeftJoinCondition = new _Def16("BadRolapStarLeftJoinCondition",
        "Context ''{0}'': Bad RolapStar left join condition type: ''{1}'' ''{2}''.", null);
     ...
     */
    public final _Def8 AggLoadingExceededErrorCount = new _Def8("AggLoadingExceededErrorCount",
     ...
     */
    public final _Def16 UnknownFactTableColumn = new _Def16("UnknownFactTableColumn",
        "Context ''{0}'': For Fact table ''{1}'', the column ''{2}'' is neither a measure or foreign key\".", null);
     ...
     */
    public final _Def18 AggMultipleMatchingMeasure = new _Def18("AggMultipleMatchingMeasure",
     ...
     */
    public final _Def2 CouldNotLoadDefaultAggregateRules = new _Def2("CouldNotLoadDefaultAggregateRules",
     ...
     */
    public final _Def9 FailedCreateNewDefaultAggregateRules = new _Def9("FailedCreateNewDefaultAggregateRules",
        "Failed to create new default aggregate rules using property ''{0}'' with value ''{1}''.", null);
     ...
     */
    public final _Def4 AttemptToChangeTableUsage = new _Def4("AttemptToChangeTableUsage",
        "JdbcSchema.Table ''{0}'' already set to usage ''{1}'' and can not be reset to usage ''{2}''.", null);
     ...
     */
    public final _Def0 BadJdbcFactoryInstantiation = new _Def0("BadJdbcFactoryInstantiation",
     ...
     */
    public final _Def0 BadJdbcFactoryAccess = new _Def0("BadJdbcFactoryAccess", "JdbcSchema Factory classname ''{0}'', illegal access.",
        null);
     ...
     */
    public final _Def17 NonNumericFactCountColumn = new _Def17("NonNumericFactCountColumn",
     ...
     */
    public final _Def19 TooManyFactCountColumns = new _Def19("TooManyFactCountColumns",
        "Candidate aggregate table ''{0}'' for fact table ''{1}'' has ''{2,number}'' fact count columns.", null);

    /**
     * <code>NoFactCountColumns</code> is '<code>Candidate aggregate table &#39;&#39;{0}&#39;&#39; for fact table &#39;&#39;{1}&#39;&#39; has no fact count columns.</code>'
     */
    public final _Def9 NoFactCountColumns = new _Def9("NoFactCountColumns",
        "Candidate aggregate table ''{0}'' for fact table ''{1}'' has no fact count columns.", null);

    /**
     * <code>NoMeasureColumns</code> is '<code>Candidate aggregate table &#39;&#39;{0}&#39;&#39; for fact table &#39;&#39;{1}&#39;&#39; has no measure columns.</code>'
     */
    public final _Def9 NoMeasureColumns = new _Def9("NoMeasureColumns",
        "Candidate aggregate table ''{0}'' for fact table ''{1}'' has no measure columns.", null);
     ...
     */
    public final _Def20 TooManyMatchingForeignKeyColumns = new _Def20("TooManyMatchingForeignKeyColumns",
        "Candidate aggregate table ''{0}'' for fact table ''{1}'' had ''{2,number}'' columns matching foreign key ''{3}''", null);
     ...
     */
    public final _Def21 DoubleMatchForLevel = new _Def21("DoubleMatchForLevel",
     ...
     */
    public final _Def16 AggUnknownColumn = new _Def16("AggUnknownColumn",
        "Candidate aggregate table ''{0}'' for fact table ''{1}'' has a column ''{2}'' with unknown usage.", null);
     ...
     */
    public final _Def16 NoAggregatorFound = new _Def16("NoAggregatorFound",
     ...
     */
    public final _Def2 NoColumnNameFromExpression = new _Def2("NoColumnNameFromExpression",
     ...
     */
    public final _Def2 AggTableNoConstraintGenerated = new _Def2("AggTableNoConstraintGenerated",
        "Aggregate star fact table ''{0}'':  A constraint will not be generated because name column is not the same as key column.", null);

    /**
     * <code>CacheFlushRegionMustContainMembers</code> is '<code>Region of cells to be flushed must contain measures.</code>'
     */
    public final _Def3 CacheFlushRegionMustContainMembers = new _Def3("CacheFlushRegionMustContainMembers",
     ...
     */
    public final _Def1 CacheFlushUnionDimensionalityMismatch = new _Def1("CacheFlushUnionDimensionalityMismatch",
        "Cannot union cell regions of different dimensionalities. (Dimensionalities are ''{0}'', ''{1}''.)", null);
     ...
     */
    public final _Def0 CacheFlushCrossjoinDimensionsInCommon = new _Def0("CacheFlushCrossjoinDimensionsInCommon",
        "Cannot crossjoin cell regions which have dimensions in common. (Dimensionalities are {0}.)", null);
     ...
     */
    public final _Def3 SegmentCacheIsNotImplementingInterface = new _Def3("SegmentCacheIsNotImplementingInterface",
     ...
     */
    public final _Def3 SegmentCacheFailedToInstanciate = new _Def3("SegmentCacheFailedToInstanciate",
     ...
     */
    public final _Def3 SegmentCacheFailedToLoadSegment = new _Def3("SegmentCacheFailedToLoadSegment",
        "An exception was encountered while loading a segment from the SegmentCache.", null);
     ...
     */
    public final _Def3 SegmentCacheFailedToSaveSegment = new _Def3("SegmentCacheFailedToSaveSegment",
        "An exception was encountered while loading a segment from the SegmentCache.", null);
     ...
     */
    public final _Def3 SegmentCacheFailedToLookupSegment = new _Def3("SegmentCacheFailedToLookupSegment",
        "An exception was encountered while performing a segment lookup in the SegmentCache.", null);
     ...
     */
    public final _Def3 SegmentCacheFailedToScanSegments = new _Def3("SegmentCacheFailedToScanSegments",
        "An exception was encountered while getting a list of segment headers in the SegmentCache.", null);
     ...
     */
    public final _Def3 SegmentCacheFailedToDeleteSegment = new _Def3("SegmentCacheFailedToDeleteSegment",
        "An exception was encountered while deleting a segment from the SegmentCache.", null);
     ...
     */
    public final _Def3 SegmentCacheWriteTimeout = new _Def3("SegmentCacheWriteTimeout",
     ...
     */
    public final _Def3 SegmentCacheLookupTimeout = new _Def3("SegmentCacheLookupTimeout",
     ...
     */
    public final _Def22 NativeEvaluationUnsupported = new _Def22("NativeEvaluationUnsupported",
     ...
     */
    public final _Def9 NativeSqlInClauseTooLarge = new _Def9("NativeSqlInClauseTooLarge",
     ...
     */
    public final _Def0 ExecutionStatementCleanupException = new _Def0("ExecutionStatementCleanupException",
     ...
     */
    public final _Def6 QueryLimitReached = new _Def6("QueryLimitReached",
     ...
     */
    public final _Def3 SqlQueryLimitReached = new _Def3("SqlQueryLimitReached",
     ...
     */
    public final _Def3 SegmentCacheLimitReached = new _Def3("SegmentCacheLimitReached",
     ...
     */
    public final _Def3 FinalizerErrorRolapSchema = new _Def3("FinalizerErrorRolapSchema",
        "An exception was encountered while finalizing a RolapSchema object instance.", null);
     ...
     */
    public final _Def3 FinalizerErrorMondrianServerImpl = new _Def3("FinalizerErrorMondrianServerImpl",
        "An exception was encountered while finalizing a RolapSchema object instance.", null);
     ...
     */
    public final _Def3 FinalizerErrorRolapConnection = new _Def3("FinalizerErrorRolapConnection",
        "An exception was encountered while finalizing a RolapConnection object instance.", null);
    ...
    public final class _Def0 extends org.eigenbase.resgen.ResourceDefinition {
        _Def0(java.lang.String key, java.lang.String baseMessage, java.lang.String[] props) {
            super(key, baseMessage, props);
        }
        public String str(String p0) {
            return this.instantiate(MondrianResource.this, new java.lang.Object[] { p0 }).toString();
        }

        public mondrian.olap.MondrianException ex(java.lang.String newMessage) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newMessage }).toString());
        }

        public mondrian.olap.MondrianException ex(java.lang.String newMessage, java.lang.Throwable newError) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newMessage }).toString(), newError);
        }
    }
    ...
    public final class _Def1 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public String str(String p0, String p1) {
            return this.instantiate(MondrianResource.this, new java.lang.Object[] { p0, p1 }).toString();
        }

        public mondrian.olap.MondrianException ex(java.lang.String newFullname, java.lang.String newQualifiedName) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newFullname, newQualifiedName }).toString());
        }

        public mondrian.olap.MondrianException ex(java.lang.String newFormatterName,
            java.lang.String newElementName,
            java.lang.Throwable newError) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newFormatterName, newElementName }).toString(), newError);
        }
    ...
    public final class _Def3 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public String str() {
            return this.instantiate(MondrianResource.this, emptyObjectArray).toString();
        }

        public mondrian.olap.MondrianException ex() {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, MondrianResource.emptyObjectArray).toString());
        }

        public mondrian.olap.MondrianException ex(java.lang.Throwable newError) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, MondrianResource.emptyObjectArray).toString(), newError);
        }
    }
    ...
    public final class _Def4 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public String str(String p0, String p1, String p2) {
            return this.instantiate(MondrianResource.this, new java.lang.Object[] { p0, p1, p2 }).toString();
        }

        public mondrian.olap.MondrianException ex(java.lang.String newFuncName,
            java.lang.String newClassName,
            java.lang.String newUdfName) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newFuncName, newClassName, newUdfName }).toString());
        }
    ...
    public final class _Def6 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.MondrianException ex(java.lang.Number newSeekOrdinal, java.lang.String newAxisName) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newSeekOrdinal, newAxisName }).toString());
        }

        public mondrian.olap.MondrianException ex(java.lang.Number newSeekOrdinal,
            java.lang.String newAxisName,
            java.lang.Throwable newError) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newSeekOrdinal, newAxisName }).toString(), newError);
        }
    }
    ...
    public final class _Def7 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public String str(String p0, String p1, String p2, String p3) {
            return this.instantiate(MondrianResource.this, new java.lang.Object[] { p0, p1, p2, p3 }).toString();
        }

        public mondrian.olap.MondrianException ex(java.lang.String newFormulaType,
            java.lang.String newUniqueName,
            java.lang.String newParentFormulaType,
            java.lang.String newParentUniqueName) {

            return new mondrian.olap.MondrianException(this
                .instantiate(MondrianResource.this,
                    new java.lang.Object[] { newFormulaType, newUniqueName, newParentFormulaType, newParentUniqueName })
                    .toString());
        }
    }
    ...
    public final class _Def8 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.MondrianException ex(java.lang.Number newAxis) {
            return new mondrian.olap.MondrianException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newAxis }).toString());
        }
    }
    ...
    public final class _Def10 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.ResourceLimitExceededException ex(java.lang.Number newResultSize, java.lang.Number newResultLimit) {
            return new mondrian.olap.ResourceLimitExceededException(
                this.instantiate(MondrianResource.this, new java.lang.Object[] { newResultSize, newResultLimit }).toString());
        }
    }
    ...
    public final class _Def11 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.ResourceLimitExceededException ex(Number newIterationLimit) {
            return new mondrian.olap.ResourceLimitExceededException(
                this.instantiate(MondrianResource.this, new Object[] { newIterationLimit }).toString());
        }
    }
    ...
    public final class _Def12 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.QueryCanceledException ex() {
            return new mondrian.olap.QueryCanceledException(
                this.instantiate(MondrianResource.this, MondrianResource.emptyObjectArray).toString());
        }
    }
    ...
    public final class _Def13 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.QueryTimeoutException ex(Number newTimeout) {
            return new mondrian.olap.QueryTimeoutException(this.instantiate(MondrianResource.this, new Object[] { newTimeout }).toString());
        }
    }
    ...
    public final class _Def14 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.InvalidHierarchyException ex(String newUniqueName) {
            return new mondrian.olap.InvalidHierarchyException(
                this.instantiate(MondrianResource.this, new Object[] { newUniqueName }).toString());
        }
    }
    ...
    public final class _Def18 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public String str(String p0, String p1, String p2, Number p3, String p4, String p5, String p6) {
            return this.instantiate(MondrianResource.this, new java.lang.Object[] { p0, p1, p2, p3, p4, p5, p6 }).toString();
        }
    }
    ...
    public final class _Def22 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian.olap.NativeEvaluationUnsupportedException ex(String newFunctionName) {
            return new mondrian.olap.NativeEvaluationUnsupportedException(
                this.instantiate(MondrianResource.this, new Object[] { newFunctionName }).toString());
        }
